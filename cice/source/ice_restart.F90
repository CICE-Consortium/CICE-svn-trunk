...
!
      ...
      do n=1,ncat
         call ice_write_ext(nu_dump,0,aicen(:,:,n,:),'ruf8',diag)
      ...
      !-----------------------------------------------------------------
      if (restart_ext) then
         ! include ghost cells for regional grids
         call ice_write_ext(nu_dump,0,uvel,'ruf8',diag)
         call ice_write_ext(nu_dump,0,vvel,'ruf8',diag)
      else
         call ice_write_ext(nu_dump,0,uvel,'ruf8',diag)
         call ice_write_ext(nu_dump,0,vvel,'ruf8',diag)
      endif
      ...
      ! radiation fields
      !-----------------------------------------------------------------
      call ice_write_ext(nu_dump,0,scale_factor,'ruf8',diag)

      call ice_write_ext(nu_dump,0,swvdr,'ruf8',diag)
      call ice_write_ext(nu_dump,0,swvdf,'ruf8',diag)
      call ice_write_ext(nu_dump,0,swidr,'ruf8',diag)
      call ice_write_ext(nu_dump,0,swidf,'ruf8',diag)

      !-----------------------------------------------------------------
      ! ocean stress (for bottom heat flux in thermo)
      !-----------------------------------------------------------------
      call ice_write_ext(nu_dump,0,strocnxT,'ruf8',diag)
      call ice_write_ext(nu_dump,0,strocnyT,'ruf8',diag)

      !-----------------------------------------------------------------
      ! internal stress
      !-----------------------------------------------------------------

      call ice_write_ext(nu_dump,0,stressp_1,'ruf8',diag)
      call ice_write_ext(nu_dump,0,stressp_3,'ruf8',diag)
      call ice_write_ext(nu_dump,0,stressp_2,'ruf8',diag)
      call ice_write_ext(nu_dump,0,stressp_4,'ruf8',diag)

      call ice_write_ext(nu_dump,0,stressm_1,'ruf8',diag)
      call ice_write_ext(nu_dump,0,stressm_3,'ruf8',diag)
      call ice_write_ext(nu_dump,0,stressm_2,'ruf8',diag)
      call ice_write_ext(nu_dump,0,stressm_4,'ruf8',diag)

      call ice_write_ext(nu_dump,0,stress12_1,'ruf8',diag)
      call ice_write_ext(nu_dump,0,stress12_3,'ruf8',diag)
      call ice_write_ext(nu_dump,0,stress12_2,'ruf8',diag)
      call ice_write_ext(nu_dump,0,stress12_4,'ruf8',diag)
      ...
      ! for mixed layer model
      if (oceanmixed_ice) then
         call ice_write_ext(nu_dump,0,sst,'ruf8',diag)
         call ice_write_ext(nu_dump,0,frzmlt,'ruf8',diag)
      endif
...
!
      ...
      do n=1,ncat
         ...
         call ice_read_ext(nu_restart,0,aicen(:,:,n,:),'ruf8',diag, &
                       field_loc_center, field_type_scalar)
         call ice_read_ext(nu_restart,0,vicen(:,:,n,:),'ruf8',diag, &
                       field_loc_center, field_type_scalar)
         call ice_read_ext(nu_restart,0,vsnon(:,:,n,:),'ruf8',diag, &
                       field_loc_center, field_type_scalar)
      ...
      if (restart_ext) then
         ! include ghost cells for regional grids
         call ice_read_ext(nu_restart,0,uvel,'ruf8',diag, &
                          field_loc_NEcorner, field_type_vector)
         call ice_read_ext(nu_restart,0,vvel,'ruf8',diag, &
                          field_loc_NEcorner, field_type_vector)
      else
         call ice_read_ext(nu_restart,0,uvel,'ruf8',diag, &
                          field_loc_NEcorner, field_type_vector)
      ...
      call ice_read_ext(nu_restart,0,scale_factor,'ruf8',diag, &
                    field_loc_center, field_type_scalar)
      call ice_read_ext(nu_restart,0,swvdr,'ruf8',diag, &
                    field_loc_center, field_type_scalar)
      call ice_read_ext(nu_restart,0,swvdf,'ruf8',diag, &
                    field_loc_center, field_type_scalar)
      call ice_read_ext(nu_restart,0,swidr,'ruf8',diag, &
                    field_loc_center, field_type_scalar)
      call ice_read_ext(nu_restart,0,swidf,'ruf8',diag, &
                    field_loc_center, field_type_scalar)
      ...
      call ice_read_ext(nu_restart,0,strocnxT,'ruf8',diag, &
                       field_loc_center, field_type_vector)
      call ice_read_ext(nu_restart,0,strocnyT,'ruf8',diag, &
                       field_loc_center, field_type_vector)
      ...
      ! include ghost cells for regional grids
      call ice_read_ext(nu_restart,0,stressp_1,'ruf8',diag)
      call ice_read_ext(nu_restart,0,stressp_3,'ruf8',diag)
      call ice_read_ext(nu_restart,0,stressp_2,'ruf8',diag)
      call ice_read_ext(nu_restart,0,stressp_4,'ruf8',diag)

      call ice_read_ext(nu_restart,0,stressm_1,'ruf8',diag)
      call ice_read_ext(nu_restart,0,stressm_3,'ruf8',diag)
      call ice_read_ext(nu_restart,0,stressm_2,'ruf8',diag)
      call ice_read_ext(nu_restart,0,stressm_4,'ruf8',diag)

      call ice_read_ext(nu_restart,0,stress12_1,'ruf8',diag)
      call ice_read_ext(nu_restart,0,stress12_3,'ruf8',diag)
      call ice_read_ext(nu_restart,0,stress12_2,'ruf8',diag)
      call ice_read_ext(nu_restart,0,stress12_4,'ruf8',diag)
      ...
      call ice_read_ext(nu_restart,0,work1,'ruf8',diag, &
                    field_loc_center, field_type_scalar)
      ...
      if (oceanmixed_ice) then
         ...
         call ice_read_ext(nu_restart,0,sst,'ruf8',diag, &
                       field_loc_center, field_type_scalar)
         call ice_read_ext(nu_restart,0,frzmlt,'ruf8',diag, &
                       field_loc_center, field_type_scalar)
      endif
