...
!-----------------------------------------------------------------------
   ...
   if (all_timers(timer_id)%in_use) then
      ...
      call abort_ice('release_timer: attempt to reset undefined timer')
   endif
...
!-----------------------------------------------------------------------
   ...
   if (all_timers(timer_id)%in_use) then
      ...
      call abort_ice('timer_clear: attempt to reset undefined timer')
...
!-----------------------------------------------------------------------
   ...
   if (all_timers(timer_id)%in_use) then
      ...
      call abort_ice('timer_start: attempt to start undefined timer')
...
!-----------------------------------------------------------------------
   ...
   if (all_timers(timer_id)%in_use) then
      ...
      call abort_ice('timer_print: attempt to print undefined timer')
