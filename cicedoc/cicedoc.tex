...
turbulent scales.  Here, $z_{\mathit {ref}}$ is a 
\index{height!reference}%
reference height of 10\,m and $z_{\mathit {ice}}$ is the roughness length scale for the
...
ferrmax & max allowed energy flux error (thermodynamics) {\dotfill\ } & 1.$\times$10$^{-3}$  W/m$^2$ \\
 ...
 floediam & effective floe diameter for lateral melt {\dotfill\ } &300. m \\
